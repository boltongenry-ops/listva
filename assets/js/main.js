...
const SITE = {
  title: "Листва",
  subtitle: "личный журнал о важном",
  author: "Артём",
  about: [
    "Это мой личный уголок — место, куда я складываю записи, которые не хочется терять: мысли, решения, важные события, маленькие открытия.",
    "Здесь нет алгоритмов и спешки. Только то, что действительно имеет значение, записанное простыми словами и сохранённое навсегда.",
    "Новые записи появляются нерегулярно — тогда, когда есть о чём рассказать. Так и должно быть."
  ],
  heroEyebrow: "медленные заметки",
